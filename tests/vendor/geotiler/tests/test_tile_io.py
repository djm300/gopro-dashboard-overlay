...
import gopro_overlay.vendor.geotiler.tile.io
from gopro_overlay.vendor.geotiler.map import Tile
from gopro_overlay.vendor.geotiler.tile.io import fetch_tile, fetch_tiles
...
async def test_fetch_tiles(session):
    ...
    ctx_ft = mock.patch.object(gopro_overlay.vendor.geotiler.tile.io, 'fetch_tile')
